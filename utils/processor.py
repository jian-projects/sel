...
class Processor():
    ...
    def train_stop(self, epoch=None):
        ...
        # if self.best_result['valid'][self.metrics[0]] < self.args.model['baseline']/2:
        #     self.best_result['break'] = True
        #     return True
        # if epoch > self.args.train['epochs']//2 and self.best_result['valid'][self.metrics[0]] < self.args.model['baseline']-0.01:
        #     self.best_result['break'] = True
        #     return True
